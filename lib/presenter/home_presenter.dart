...
class HomePresenter extends ChangeNotifier {
  ...
  fetchFeaturedCategories() async {
    print("1. Home Presenter, featuredProduct Page : ");
    print(featuredProductPage);
  ...
  fetchFeaturedProducts() async {
    ...
    print("home_presenter, productResponse.products!");
    ...
    // print("1. Home Presenter, featuredProduct : ");
  ...
  fetchAllProducts() async {
    ...
    print("2. Home Presenter, featuredProduct : ");
    print(productResponse);
