...
class ProductRepository {
  Future<ProductMiniResponse> getFeaturedProducts({page = 1}) async {
    ...
    print('featured?page : featured?page : featured?page :');
    print('featured?page : '+url);

    print('App-Language : ');
    print(app_language.$!);
    print('Currency-Cod : '+SystemConfig.systemCurrency!.code!);
    print('Currency-Exchange-Rate : ');
    print(SystemConfig.systemCurrency!.exchangeRate!);
    ...
    final response = await ApiRequest.get(url: url, headers: {
     ...
     print("Product Repository : "+response.body);
    print("Product Repository-2 : ");
    print(productMiniResponseFromJson(response.body));
  ...
  Future<ProductMiniResponse> getFilteredProducts(
    ...
    print("getFilteredProducts :");
    print(url.toString());
    final response = await ApiRequest.get(url: url, headers: {
      "App-Language": app_language.$!,
      "Currency-Code": "IN",//SystemConfig.systemCurrency!.code!,
      "Currency-Exchange-Rate":
          SystemConfig.systemCurrency!.exchangeRate.toString(),
    });
    return productMiniResponseFromJson(response.body);
