...
import 'package:active_ecommerce_flutter/screens/ContactInf.dart';
import 'package:active_ecommerce_flutter/screens/Aboutus.dart';
...
class _HomeState extends State<Home> with TickerProviderStateMixin {
  ...
  Widget buildHomeFeatureProductHorizontalList(HomePresenter homeData) {
    print("Home, buildHomeFeatureProductHorizontalList :");
    print(homeData.featuredProductList.length);
                ...
                child: Stack(
                  children: <Widget>[
                    Container(
                        ...
                        height: 140,
                        //decoration: BoxDecorations.buildBoxDecoration_1(),
                        child: AIZImage.radiusImage(i, 10)),
                    Align(
